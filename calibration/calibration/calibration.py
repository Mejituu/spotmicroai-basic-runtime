...
while True:
    options = {
        ...
        12: 'arm_rotation         - CHANNEL[' + str(Config().get(Config.ARM_CONTROLLER_SERVOS_ARM_ROTATION_CHANNEL)) + ']  - ANGLE[' + str(Config().get(Config.ARM_CONTROLLER_SERVOS_ARM_ROTATION_REST_ANGLE)) + ']',
        13: 'arm_lift             - CHANNEL[' + str(Config().get(Config.ARM_CONTROLLER_SERVOS_ARM_LIFT_CHANNEL)) + ']  - ANGLE[' + str(Config().get(Config.ARM_CONTROLLER_SERVOS_ARM_LIFT_REST_ANGLE)) + ']',
        14: 'arm_range            - CHANNEL[' + str(Config().get(Config.ARM_CONTROLLER_SERVOS_ARM_RANGE_CHANNEL)) + '] - ANGLE[' + str(Config().get(Config.ARM_CONTROLLER_SERVOS_ARM_RANGE_REST_ANGLE)) + ']',
        15: 'arm_cam_tilt         - CHANNEL[' + str(Config().get(Config.ARM_CONTROLLER_SERVOS_ARM_CAM_TILT_CHANNEL)) + '] - ANGLE[' + str(Config().get(Config.ARM_CONTROLLER_SERVOS_ARM_CAM_TILT_REST_ANGLE)) + ']'}
